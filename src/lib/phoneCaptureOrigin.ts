 ...
 * If you open the app as `http://localhost:5173`, the QR would encode localhost — the phone
 * tries to connect to itself, not your computer. Set `VITE_PHONE_CAPTURE_ORIGIN` to your
 * machine's LAN URL (same port), e.g. `http://192.168.1.10:5173`, then restart Vite.
 */
